...
class DeviceSensors:
    ...
    def get_room_weather(self):
        ...
        return {
            ...
            "summary": f"The room is {weather_desc} with {light_desc}. Temperature is {temp_data['celsius']}°C ({temp_data['fahrenheit']}°F), humidity at {humidity}%, and light level at {light_percent}% ({light_data['voltage']}V from photoresistor)."
        }
